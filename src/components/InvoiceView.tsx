              ...
              <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 pb-2">
                <div className="flex flex-col items-center md:items-start gap-3">
                  ...
                  <div className="space-y-1 text-center md:text-left">
                    ...
                    <div className="text-[11px] text-slate-800  font-extrabold uppercase tracking-wide leading-none mt-1 print:text-black">
                ...
                <div className="bg-slate-50 border border-slate-100   p-4 rounded-2xl max-w-xs text-left text-[9px] space-y-1 bg-opacity-70 print:bg-slate-50 print:border-slate-200">
                  ...
                  <p className="text-slate-700  font-extrabold text-[9px] uppercase leading-tight">Distribuidor Autorizado de Celulares</p>
                  <p className="text-slate-500  font-medium">Auto. No: <span className="font-bold text-slate-900 ">0000003130</span></p>
                  <p className="text-slate-500  font-medium">NUV: <span className="font-bold text-slate-900 ">00000024390</span></p>
                  <p className="text-slate-400  font-medium text-[8px] italic">Socio Regulado - Res. MinTIC 5050/2016 Col.</p>
                </div>
              </div>
